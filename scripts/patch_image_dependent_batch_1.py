...
MARKER = "const IMAGE_DEPENDENT_BATCH_1="
if MARKER in html:
    print("Image-dependent batch 1 already present; nothing to do.")
    raise SystemExit(0)

if 'id="danieana-image-support-style"' not in html:
    raise SystemExit("Batch patch aborted: production image support is not present.")
...
questions = [
    {
        ...
        "support": "",
        "images": [{"url": "./media/image-dependent/q_4000245684.png", "context": "enunciado", "alt": "Fotografia de Bronislaw Malinowski durante trabalho de campo entre habitantes das Ilhas Trobriand"}],
        "options": [
    ...
    },
    {
        ...
        "images": [{"url": "./media/image-dependent/q_4000146570.jpeg", "context": "enunciado", "alt": "Ilustração em que a sociedade aparece exercendo pressão sobre indivíduos"}],
        "options": [
    ...
    },
    {
        ...
        "images": [{"url": "./media/image-dependent/q_4000037773.png", "context": "enunciado", "alt": "Tabela de Pierre Bourdieu comparando gostos e práticas sociais entre classes"}],
        "options": [
    ...
    },
    {
        ...
        "support": "",
        "images": [{"url": "./media/image-dependent/q_4000305647.png", "context": "enunciado", "alt": "Charge do ENEM relacionada ao direito social à moradia"}],
        "options": [
    ...
    },
    {
        ...
        "images": [{"url": "./media/image-dependent/q_4000084413.png", "context": "enunciado", "alt": "Charge que contrasta modos diferentes de avaliar culturas e costumes"}],
        "options": [
...
logic = f'''\nconst IMAGE_DEPENDENT_BATCH_1={payload};\nfor(const q of IMAGE_DEPENDENT_BATCH_1){{\n  const sourceId=String(q.sourceQuestionId||q.id);\n  if(!QUESTIONS.some(existing=>String(existing.sourceQuestionId||existing.id)===sourceId))QUESTIONS.push(q);\n}}\n'''

anchor = html.rfind("\nupdateModePanels();")
if anchor < 0:
    raise SystemExit("Batch patch aborted: startHumanasApp closing anchor not found.")

html = html[:anchor] + logic + html[anchor:]
path.write_text(html, encoding="utf-8")
print(f"Image-dependent batch 1 injected into {path}.")
